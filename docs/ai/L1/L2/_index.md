...
| [acp_runtime.md](acp_runtime.md)                      | Local Project Folder, ACP child-process boundary, readiness, and verification limits | Maintaining the local coding Agent derivative foundation |
